  ...
  <div class="min-h-screen bg-gray-50">
    <div>
      <div class="min-h-screen flex flex-col md:flex-row bg-white">
        <!-- Left Panel -->
        <div
          class="bg-[#f8fafc] h-screen md:w-1/2 w-full flex flex-col justify-center items-center px-6 py-12 md:py-24 text-center md:text-left relative">
          ...
          <!-- Badge -->
          <div
            class="bg-[#e0ecff] text-[#003c88] text-xs font-semibold px-3 py-1 rounded-full mb-6 md:mb-4 uppercase tracking-wider mt-20 md:mt-20">
          ...
          <div>
            ...
            <p class="text-base text-gray-600 max-w-md mb-6">
              Discover intelligent hiring and seamless job matching. Job-Konect links top talent with top employers—fast
              and efficiently.
            </p>
            <!-- Form -->
            <form class="w-full max-w-md space-y-4" @submit="handleSubmit">
              ...
              <button type="submit"
                ...
                :disabled="isSubmitting || !email" :class="{
                ...
                <span class="h-full w-fit">
                  <svg v-if="!isSubmitting" xmlns="http://www.w3.org/2000/svg"
                    class="w-8 h-5 transform origin-left group-hover:animate-jello" viewBox="0 0 38 15" fill="none">
                    <path fill="white"
